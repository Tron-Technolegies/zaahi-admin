...
export default function Sidebar() {
  return (
    <div className="w-75 bg-neutral-800 min-h-screen lg:block hidden sticky top-0 left-0 flex flex-col p-3">
      <h1 className="text-3xl text-gray-100 mt-5 text-center pb-5 border-b">
        Zaahi Admin
      </h1>
